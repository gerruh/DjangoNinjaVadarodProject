...
from rest_api.procedure.schemas.output import ProcedureBaseOutputSchema, ProcedureDetailOutputSchema, \
...
procedure_router.add_api_operation(
    ...
    path='/',
    response={
        HTTPStatus.OK: list[ProcedureListOutputSchema],
...
procedure_router.add_api_operation(
    ...
    path='/{procedure_id}',
    response={
        HTTPStatus.OK: ProcedureDetailOutputSchema,
        HTTPStatus.NOT_FOUND: ErrorResponse
    },
...
procedure_router.add_api_operation(
    ...
    path='/',
    response={
        HTTPStatus.CREATED: ProcedureBaseOutputSchema,
